...
0x0, 0x77073096, 0xee0e612c, 
0x990951ba, 0x76dc419, 0x706af48f, 0xe963a535, 0x9e6495a3,
0xedb8832, 
0x79dcb8a4, 0xe0d5e91e, 0x97d2d988, 0x9b64c2b, 0x7eb17cbd, 0xe7b82d07, 
0x90bf1d91,
...
System.Text.Encoding.Default.GetBytes(msg);//解决中文的问题
   ...
   public class Program
   {
       public static void Main()
       {
           ...
           ////int x=fs.Read(chars, 0, (int)fs.Length);
          ...
          //string message= File.ReadAllText(path);
           byte[] bytes = null;
            ...
            //string message = BitConverter.ToString(bytes).Replace("-","");
            Console.WriteLine(message);
           


           //string message = "sq123456789";
          int output= CRC32.GetCRC32(message);
          Console.WriteLine(Convert.ToString(output,16));


          //Console.WriteLine(Convert.ToInt32(output.ToString(),16));
           ...
           */
           ...
           Console.WriteLine();
           byte[] bytes = null;
           bytes = Encoding.Default.GetBytes(chars);
           Console.WriteLine("变成byte[]后");
           foreach (byte item in bytes)
           {
               Console.Write(item+"  ");
           }
